...
const LocalMode = () => {
    ...
    useEffect(() => {
        ...
        const paddleSpeed = 0.06; // Adjust this for overall movement speed
        const smoothFactor = 0.05; // How smooth the movement is, the higher the value, the smoother the movement
