...
const SearchDropdown = React.forwardRef(({ isVisible, currentUser }, ref) => {
  ...
  return (
    <>
      <div id="searchBarWrapper" className="hidden flex-grow md:flex justify-center relative">
        <div className="relative w-3/4 xl:w-2/3">
          ...
          {showDropdown && (results.length > 0 || isLoading) && (
            <div className="absolute w-full mt-2 bg-gray-800 border-2 border-pink-500 rounded-md shadow-lg z-50">
              {isLoading ? (
      ...
      {isVisible && (
        ...
        >
          ...
          <div className="w-full max-w-lg relative">
            ...
            {showDropdown && (results.length > 0 || isLoading) && (
              <div className="absolute w-full mt-2 bg-gray-800 border-2 border-pink-500 rounded-md shadow-lg">
                {isLoading ? (
                  <div className="p-4 text-teal-200 text-center">Loading...</div>
                ) : (
                  <ul>
