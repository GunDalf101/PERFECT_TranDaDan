  ...
  return (
    <>
      <div className={`${styles.chat_content}`}>
        ...
        <div ref={chatBodyRef} className="flex-1 overflow-y-auto flex flex-col-reverse py-6 px-2">
        ...
        <form
          ...
          className="h-20 px-6 flex items-center space-x-4"
        >
          <div className="flex flex-1 space-x-3 p-3 bg-black rounded-lg h-[80%] ">
            <input
              type="text"
              value={newMessage}
              onChange={(e) => setNewMessage(e.target.value)}
              placeholder="Type a message..."
              className="w-full p-2 rounded-lg bg-[#2c2a2aa8] text-white focus:outline-none focus:border-blue-500 pr-12"
            />
            <button
              type="submit"
              className="bg-[#1b243b] hover:bg-blue-500 text-white rounded-lg w-[5%]"
            >
